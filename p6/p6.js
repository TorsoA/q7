...
function
    ...
    var texto = document.getElementById("resp_A-P6");
    ...
    mensagemp.innerHTML = `<p> Obrigado por jogar! </p>`;
    ...
    if (numero6.src.match("../img/6.png")) {
        numero6.src = "../img/6vermelho.png";
